/*************************************************************************
  > File Name: cstl_md5.c
  > Author:perrynzhou 
  > Mail:perrynzhou@gmail.com 
  > Created Time: Sun 09 Feb 2020 10:41:16 PM CST
 ************************************************************************/
#include "cstl_md5.h"
#include <stdio.h>
#include <string.h>
...
int main(int argc, char *argv[])
{
	...
	const char *test_str = "perrnzhoun_dsdfsdf.com";

	// test file md5
	ret = md5_file(file_path, md5_str);
	if (0 == ret)
	{
		printf("[%s] md5 value:\n", file_path);
		printf("%s\n", md5_str);
	...
	// test string md5 
	md5_string((unsigned char *)test_str, strlen(test_str), md5_str);
